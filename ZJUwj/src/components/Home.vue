...
<template>
  <div class="home">
      ...
      <el-col :span="18">
        <!--标签页-->
         <el-tabs type="border-card" v-model="activeName">
            ...
            <el-tab-pane label="回答情况" name="hdtj">
    ...
    <el-dialog title="添加问卷" :visible.sync="dialogShow" :close-on-click-modal="false" class="dialog">
      <el-form ref="form" :model="willAddWj" label-width="80px">
        ...
        <el-form-item label="问卷描述" style="width: 100%;">
          <el-input v-model="willAddWj.desc" type="textarea" placeholder="请输入问卷描述" rows="3"></el-input>
        </el-form-item>
        <el-form-item label="填写要求" style="width: 100%;">
          <el-checkbox v-model="willAddWj.register">只允许注册用户填写问卷</el-checkbox>
        </el-form-item>
        <el-form-item label="总共填写次数限制" style="width: 100%;" >
          <el-input v-model="willAddWj.totalnumber" placeholder="请输入填写次数限制，若无则不填" ></el-input>
        </el-form-item>
        <el-form-item label="每日填写次数限制" style="width: 100%;" >
          <el-input v-model="willAddWj.daynumber" placeholder="请输入每日填写次数限制，若无则不填" ></el-input>
        </el-form-item>
        <el-form-item label="填写周期" style="width: 100%;">
          <el-input v-model="willAddWj.days" type="textarea" placeholder="请输入填写周期天数，若无则不填"></el-input>
        </el-form-item>
      </el-form>
    ...
    <!--编辑问卷弹窗-->
    <el-dialog title="编辑问卷" :visible.sync="dialogEdit" :close-on-click-modal="false" class="dialog">
      <el-form ref="form" :model="willAddWj" label-width="80px">
        <el-form-item label="问卷标题" style="width: 100%;" required>
          <el-input v-model="willAddWj.title" placeholder="请输入问卷标题" ></el-input>
        </el-form-item>
        ...
        <el-form-item label="总共填写次数限制" style="width: 100%;" required>
          <el-input v-model="willAddWj.totalnumber" placeholder="请输入填写次数限制，若无则不填" ></el-input>
        </el-form-item>
        <el-form-item label="每日填写次数限制" style="width: 100%;" required>
          <el-input v-model="willAddWj.daynumber" placeholder="请输入填写次数限制，若无则不填" ></el-input>
        </el-form-item>    
        <el-form-item label="填写周期" style="width: 100%;">
          <el-input v-model="willAddWj.days" type="textarea" placeholder="请输入填写周期天数，若无则不填"></el-input>
        </el-form-item>
      ...
      <div style="width: 100%;text-align: right">
        <el-button style="margin-left: 10px;" @click="dialogEdit=false">取消</el-button>  <!-- 编辑问卷怎么回事？？？-->
        <el-button type="primary" style="margin-left: 10px;" @click="addWj">确定</el-button>
      </div>
    </el-dialog>
    ...
    data(){
      return{
        ...
        willAddWj:{
          ...
          totalnumber:'',
          daynumber:'',
          desc:'感谢您于百忙之中填写本问卷，您的回答和建议将为我们提供很大帮助！',
        },
        shareInfo:{
          url:'',
        },
    ...
    computed:{
      ...
      nowSelect(){
        ...
        return{
          ...
          days:now.days,
          totalnumber:now.totalnumber,
          daynumber:now.daynumber
        }
      },
    },
    methods:{
      ...
      addWj(){
        ...
        if(this.willAddWj.days!=''&&this.willAddWj.days<=0)
        {
          this.$message({
            type: 'error',
            message: '请设置合理的填写周期'
        ...
        designOpera({
          ...
          register:this.willAddWj.register,
          days:this.willAddWj.days,
          totalnumber:this.willAddWj.totalnumber,
          daynumber:this.willAddWj.daynumber,
        })
          .then(data=>{
            console.log(data);
            if(data.code==0){
